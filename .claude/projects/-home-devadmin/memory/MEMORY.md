...
- [Indexing work blocked on Shared.Crypto merge](project_indexing_crypto.md) — indexing feature queued behind HMC.Shared.Crypto merge (as of 2026-04-15)
- [Index reconciliation — design constraints](project_index_reconciliation.md) — AsOfDate too dense, ChunkId broken by schema issue, Id (doc GUID) is the reconciliation anchor
- [Branch naming and conservative change scope](feedback_branch_and_scope.md) — branch = feature/{descriptor}; only touch what's needed, heavy team review
